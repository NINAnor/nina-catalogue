...
MIGRATION_MODULES = {"sites": "metadata_catalogue.contrib.sites.migrations"}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "metadata_catalogue.users.adapters.AccountAdapter"
